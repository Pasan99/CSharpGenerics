...
namespace CSharpGenerics.Utilities
{
    static class CsvFileReader
    {
        public static List<T> Read<T>(string fileName) where T : class, new()
        {
            ...
            // get all class properties (Ex: In User class -> Name, Email, Id)
